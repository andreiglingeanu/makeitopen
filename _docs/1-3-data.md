...
title: Integrând Datele cu React Native
layout: docs
permalink: /tutorials/building-the-f8-app/data/
intro: >
  Aici explicăm fluxul de date în React Native, cum Redux funcționează în aplicația F8
  și procesul simplu de conectare cu Server-ul Parse.
---
